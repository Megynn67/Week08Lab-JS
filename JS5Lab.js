...
let myGreeting = new Greeting('Megan', 'NM');
myGreeting.hello()
...
myBook.describe();           //Step 3

console.log(myBook.title);   //Step 4 - print title

console.log(myBook.author);  //Step 5 - print author

let yourBook = new Book('Light on Yoga', 'BKS Iyengar')       //Step 6 your book
yourBook.describe();

console.log (yourBook.describe(yourBook));
...
class Child extends Parent {       //Step 1
  constructor(name, age) {
    super(name, age)
  }
}
